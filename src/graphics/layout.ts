...
export const getConstraintRect = (
  constraint: number[],
...
export const mapUVToCell = (
  ...
  for (let i = 0; i < depth; i++) {
    ...
    if (localU < size) {
      cellX = 0
      offsetX = 0
    } else if (localU < size + gap) {
      return { valid: false, x: -1, y: -1 }
    } else if (localU < 2 * size + gap) {
      cellX = 1
      offsetX = size + gap
    } else if (localU < 2 * size + 2 * gap) {
      return { valid: false, x: -1, y: -1 }
    } else {
      cellX = 2
      offsetX = 2 * (size + gap)
    ...
    if (localV < size) {
      cellY = 0
      offsetY = 0
    } else if (localV < size + gap) {
      return { valid: false, x: -1, y: -1 }
    } else if (localV < 2 * size + gap) {
      cellY = 1
      offsetY = size + gap
    } else if (localV < 2 * size + 2 * gap) {
      return { valid: false, x: -1, y: -1 }
    } else {
      cellY = 2
      offsetY = 2 * (size + gap)
