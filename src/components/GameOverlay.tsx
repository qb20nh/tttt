          ...
          <div className='flex items-center gap-4'>
            ...
            <div className='w-12 h-12 flex items-center justify-center'>
              {currentPlayer === 'X'
                ? (
                  <X
                    className='w-10 h-10 text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]'
                    strokeWidth={3}
                  />
                  )
                : (
                  <Circle
                    className='w-10 h-10 text-rose-500 drop-shadow-[0_0_15px_rgba(244,63,94,0.5)]'
                    strokeWidth={3}
                  />
                  )}
            </div>
            ...
            <div
              className={`overflow-hidden transition-all duration-300 ease-out ${isAiThinking ? 'max-w-[200px] opacity-100' : 'max-w-0 opacity-0'}`}
            >
          ...
          <div className='relative bg-slate-900 border border-slate-700 p-8 rounded-2xl shadow-2xl text-center max-w-sm mx-4 transform transition-all scale-100'>
            ...
            {winner === 'Draw'
              ...
              : (
                <>
                  <div
                    className={`text-8xl font-black mb-6 ${winner === 'X' ? 'text-cyan-400' : 'text-rose-500'} drop-shadow-[0_0_30px_rgba(255,255,255,0.2)]`}
                  >
                    {winner}
                  </div>
