                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>• Win a local board to claim that cell in the grid above.</li>
                                <li>• Your move sends the opponent to a specific sector in the next turn (highlighted in gold).</li>
                                <li>• If a target board is full or already won, you can play anywhere.</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                            ...
                            <ul className="space-y-2 text-sm">
                                <li>• <span className="text-white font-bold">Scroll</span> to zoom in/out.</li>
                                <li>• <span className="text-white font-bold">Right-Click + Drag</span> to pan.</li>
                                <li>• <span className="text-white font-bold">Left-Click</span> to place your mark.</li>
                            </ul>
                        </div>
                    </div>
                </div>
